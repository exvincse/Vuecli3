          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text"
                     ...
                     placeholder="請輸入優惠碼">
              <span class="text-danger"
                    v-if="errors.has('coupon_code')">優惠碼不得為空</span>
            </div>
            <div class="form-group">
              ...
              <input type="date"
                     ...
                     v-model="due_date">
              <span class="text-danger"
                    v-if="errors.has('due_date')">日期不得為空</span>
            </div>
            <div class="form-group">
              ...
              <span class="text-danger"
                    v-if="errors.has('price')">折扣百分比不得為空</span>
            </div>
            <div class="form-group">
